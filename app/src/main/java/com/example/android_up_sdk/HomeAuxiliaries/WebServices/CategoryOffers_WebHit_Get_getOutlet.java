...
public class CategoryOffers_WebHit_Get_getOutlet {
    ...
    public void requestCategoryOffers(Context _context, final IWebCallback iWebCallback, int _page, int _categoryId, int _popularCategoryId,
                                      ...
                                      double _lng, boolean _isgenderRequired, String _strSearchTags, String _strParentId, int _interestId) {
        ...
        if (_strParentId.length() > 0) {
            params.put("parents_id", _strParentId);
        }

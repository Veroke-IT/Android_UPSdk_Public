...
public class HomeCategoriesAdapter extends RecyclerView.Adapter<HomeCategoriesAdapter.MyViewHolder> {
    ...
    ArrayList<DModel_Categories> mData;
    float cornerRadius;
    Context mContext;

    public HomeCategoriesAdapter(final IAdapterCallback iAdapterCallback, Context _context, ArrayList<DModel_Categories> data) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.lay_home_sec_cat, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder viewHolder, int position) {
        ...
        Picasso.get()
                .load(AppConfig.getInstance().getBaseUrlImage() + mData.get(position).getCategoryImage())
                .error(R.drawable.icn_placeholder_banner)
                .placeholder(R.drawable.icn_placeholder_banner)
                .into(viewHolder.imvThumbnail);

        Picasso.get()
                .load(AppConfig.getInstance().getBaseUrlImage() + mData.get(position).getCategoryLogo())
                .error(R.drawable.icn_placeholder_banner)
                .placeholder(R.drawable.icn_placeholder_banner)
                .into(viewHolder.imvIcon);

        viewHolder.txvTitle.setText(mData.get(position).getCategoryName());
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            rlParent = itemView.findViewById(R.id.layhomcat_parent);

            imvThumbnail = itemView.findViewById(R.id.layhomcat_imv_thumbnail);
            imvThumbnail.setRadius(cornerRadius, true, true, true, true);

            imvIcon = itemView.findViewById(R.id.layhomcat_imv_icon);
            txvTitle = itemView.findViewById(R.id.layhomcat_txv_title);
        }

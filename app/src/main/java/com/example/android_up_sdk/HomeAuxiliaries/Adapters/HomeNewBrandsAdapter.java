...
public class HomeNewBrandsAdapter extends RecyclerView.Adapter<HomeNewBrandsAdapter.MyViewHolder> {

    IAdapterCallback iAdapterCallback;

    LayoutInflater inflater;
    ArrayList<DModel_NewBrands> mData;
    float cornerRadius;
    Context mContext;


    public HomeNewBrandsAdapter(final IAdapterCallback iAdapterCallback, Context _context, ArrayList<DModel_NewBrands> data) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.lay_home_sec_new_brand, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder viewHolder, int position) {
        ...
        Picasso.get()
                .load(AppConfig.getInstance().getBaseUrlImage() + mData.get(position).getOutlet_logo())
        ...
        viewHolder.txvTitle.setText(mData.get(position).getParent_outlet_name());
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView txvFranchiseTitle, txvTitle;

        public MyViewHolder(View itemView) {
            super(itemView);

            rlParent = itemView.findViewById(R.id.layhomenewbrands_parent);
            imvThumbnail = itemView.findViewById(R.id.layhomenewbrands_imv_thumbnail);
            imvThumbnail.setRadius(cornerRadius, true, true, true, true);

            txvFranchiseTitle = itemView.findViewById(R.id.layhomenewbrands_txv_franchise);

            txvTitle = itemView.findViewById(R.id.layhomenewbrands_txv_title);
        }

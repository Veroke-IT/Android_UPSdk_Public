...
public class NewBrandsPagerFragment extends Fragment implements View.OnClickListener {
    ...
    private void init() {
        strCategoryName = requireContext().getResources().getString(R.string.frg_new_brands);
    ...
    private PagerAdapter buildAdapter() {
        //Todo Change Adapter
        return (new NewBrandsPagerAdapter(getActivity(), getChildFragmentManager(), listTitle));
    }
    ...
    public class NewBrandsPagerAdapter extends FragmentPagerAdapter {
        ...
        public NewBrandsPagerAdapter(Context _context, FragmentManager mgr, List<String> _listTitle) {
            super(mgr);
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case AppConstt.ViewPagerState.CATEGORY_OUTLET:
                    frg = NewBrandsOutletFragment.newInstance(position,AppConstt.DEFAULT_VALUES.SORT_BY_LOCATION);
                    break;

                case AppConstt.ViewPagerState.CATEGORY_PARENT:
                    frg = NewBrandsFragment.newInstance(position,AppConstt.DEFAULT_VALUES.SORT_BY_ALPHABETICALLY);
                    break;
